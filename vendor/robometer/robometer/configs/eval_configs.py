...
class EvalServerConfig:
    ...
    autocast_dtype: str = field(
        default="bf16",
        metadata={"help": "CUDA autocast dtype for reward inference: bf16, fp16, or none"},
    )
    use_unsloth: bool | None = field(
        default=None,
        metadata={"help": "Override checkpoint model.use_unsloth for eval server; None keeps checkpoint config"},
    )
