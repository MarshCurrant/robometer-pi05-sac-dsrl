        ...
        def make_env(
            ...
            if use_async_reward_relabel:
                ...
                wrapper_kwargs = {
                    ...
                    "success_detection_mode": async_reward_relabel_kwargs.get(
                        "success_detection_mode", "standard"
                    ),
                    "terminal_adjacent_delta_detection": async_reward_relabel_kwargs.get(
                        "terminal_adjacent_delta_detection", False
                    ),
                    "terminal_adjacent_delta_threshold": async_reward_relabel_kwargs.get(
                        "terminal_adjacent_delta_threshold", float("inf")
                    ),
                    "wait_for_completion_on_episode_end": async_reward_relabel_kwargs.get(
                        "wait_for_completion_on_episode_end", False
                    ),
                }
